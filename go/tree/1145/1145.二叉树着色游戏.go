 ...
 * }
 */
// TODO,思路错了,计算x的左右子节点数不对
// 这里要算x的左右子树的节点数
// func btreeGameWinningMove(root *TreeNode, n int, x int) bool {
// 	var (
// 		l, r int
// 		dfs  func(p *TreeNode, isX, isLeft bool)
// 	)
// 	dfs = func(p *TreeNode, isX, isL bool) {
// 		if p == nil {
// 			return
// 		}
// 		if isX && p.Val != x {
...
// 			}
// 		}
// 		dfs(p.Left, p.Val == x, true)
// 		dfs(p.Right, p.Val == x, false)
// 	}
// 	dfs(root, root.Val == x, true)

// 	num := n - 1 - l - r
// 	return max(max(l, r), num)*2 > n
// }
...
func btreeGameWinningMove(root *TreeNode, n, x int) bool {
	...
	dfs(root)
	fmt.Println(n-1-lsz-rsz, lsz, rsz, n)
